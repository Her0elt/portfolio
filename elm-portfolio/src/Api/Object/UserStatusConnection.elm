...
module Api.Object.UserStatusConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.UserStatusEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.UserStatusConnection
edges object____ =
