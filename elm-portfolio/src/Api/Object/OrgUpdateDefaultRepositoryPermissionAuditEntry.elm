...
module Api.Object.OrgUpdateDefaultRepositoryPermissionAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.OrgUpdateDefaultRepositoryPermissionAuditEntry
actor object____ =
