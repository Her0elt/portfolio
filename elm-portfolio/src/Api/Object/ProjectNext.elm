...
module Api.Object.ProjectNext exposing (..)
...
-}
closed : SelectionSet Bool Api.Object.ProjectNext
closed =
...
-}
closedAt : SelectionSet (Maybe Api.ScalarCodecs.DateTime) Api.Object.ProjectNext
closedAt =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
createdAt : SelectionSet Api.ScalarCodecs.DateTime Api.Object.ProjectNext
createdAt =
...
creator :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.ProjectNext
creator object____ =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
databaseId : SelectionSet (Maybe Int) Api.Object.ProjectNext
databaseId =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
description : SelectionSet (Maybe String) Api.Object.ProjectNext
description =
...
fields :
    ...
    -> SelectionSet decodesTo Api.Object.ProjectNextFieldConnection
...
id : SelectionSet Api.ScalarCodecs.Id Api.Object.ProjectNext
id =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
number : SelectionSet Int Api.Object.ProjectNext
number =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
public : SelectionSet Bool Api.Object.ProjectNext
public =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
resourcePath : SelectionSet Api.ScalarCodecs.Uri Api.Object.ProjectNext
resourcePath =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
shortDescription : SelectionSet (Maybe String) Api.Object.ProjectNext
shortDescription =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
title : SelectionSet (Maybe String) Api.Object.ProjectNext
title =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
updatedAt : SelectionSet Api.ScalarCodecs.DateTime Api.Object.ProjectNext
updatedAt =
...
@deprecated The `ProjectNext` API is deprecated in favour of the more capable `ProjectV2` API. Follow the ProjectV2 guide at <https://github.blog/changelog/2022-06-23-the-new-github-issues-june-23rd-update/>, to find a suitable replacement. Removal on 2023-01-01 UTC.
-}
url : SelectionSet Api.ScalarCodecs.Uri Api.Object.ProjectNext
url =
...
-}
viewerCanUpdate : SelectionSet Bool Api.Object.ProjectNext
viewerCanUpdate =
...
views :
    ...
    -> SelectionSet decodesTo Api.Object.ProjectViewConnection
    -> SelectionSet decodesTo Api.Object.ProjectNext
