...
module Api.Object.DeploymentReviewerConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.DeploymentReviewerEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DeploymentReviewerConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Api.Union.DeploymentReviewer
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DeploymentReviewerConnection
nodes object____ =
...
-}
totalCount : SelectionSet Int Api.Object.DeploymentReviewerConnection
totalCount =
