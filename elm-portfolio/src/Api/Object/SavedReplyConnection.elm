...
module Api.Object.SavedReplyConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.SavedReplyEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.SavedReplyConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Api.Object.SavedReply
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.SavedReplyConnection
nodes object____ =
