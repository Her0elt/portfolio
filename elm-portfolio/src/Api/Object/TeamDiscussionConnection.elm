...
module Api.Object.TeamDiscussionConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.TeamDiscussionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.TeamDiscussionConnection
edges object____ =
