...
module Api.Object.DiscussionPollOptionConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.DiscussionPollOptionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DiscussionPollOptionConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Api.Object.DiscussionPollOption
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DiscussionPollOptionConnection
nodes object____ =
...
-}
totalCount : SelectionSet Int Api.Object.DiscussionPollOptionConnection
totalCount =
