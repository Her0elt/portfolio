...
module Api.Object.OrgRestoreMemberMembershipRepositoryAuditEntryData exposing (..)
...
repository :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.OrgRestoreMemberMembershipRepositoryAuditEntryData
