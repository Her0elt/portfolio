...
module Api.Object.RepositoryVisibilityChangeDisableAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepositoryVisibilityChangeDisableAuditEntry
actor object____ =
