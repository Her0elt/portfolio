...
module Api.Object.SecurityAdvisoryConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.SecurityAdvisoryEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.SecurityAdvisoryConnection
edges object____ =
