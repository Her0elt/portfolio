...
module Api.Object.SponsorsTierConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.SponsorsTierEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.SponsorsTierConnection
edges object____ =
