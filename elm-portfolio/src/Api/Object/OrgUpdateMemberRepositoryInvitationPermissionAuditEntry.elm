...
module Api.Object.OrgUpdateMemberRepositoryInvitationPermissionAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.OrgUpdateMemberRepositoryInvitationPermissionAuditEntry
actor object____ =
