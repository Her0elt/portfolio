...
module Api.Object.RepoConfigUnlockAnonymousGitAccessAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepoConfigUnlockAnonymousGitAccessAuditEntry
actor object____ =
