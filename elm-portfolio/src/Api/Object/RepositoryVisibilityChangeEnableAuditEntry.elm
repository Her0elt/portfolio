...
module Api.Object.RepositoryVisibilityChangeEnableAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepositoryVisibilityChangeEnableAuditEntry
actor object____ =
