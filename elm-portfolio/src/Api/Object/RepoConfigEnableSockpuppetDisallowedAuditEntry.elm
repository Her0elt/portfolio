...
module Api.Object.RepoConfigEnableSockpuppetDisallowedAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepoConfigEnableSockpuppetDisallowedAuditEntry
actor object____ =
