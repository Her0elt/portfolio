...
module Api.Object.EnterpriseMemberConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.EnterpriseMemberEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.EnterpriseMemberConnection
edges object____ =
