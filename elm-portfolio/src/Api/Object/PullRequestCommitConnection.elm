...
-}
edges :
    SelectionSet decodesTo Api.Object.PullRequestCommitEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.PullRequestCommitConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Api.Object.PullRequestCommit
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.PullRequestCommitConnection
nodes object____ =
