...
module Api.Object.RepoConfigDisableSockpuppetDisallowedAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepoConfigDisableSockpuppetDisallowedAuditEntry
actor object____ =
