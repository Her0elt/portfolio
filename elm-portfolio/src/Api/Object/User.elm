...
anyPinnableItems :
    ...
    -> SelectionSet Bool Api.Object.User
...
avatarUrl :
    ...
    -> SelectionSet Api.ScalarCodecs.Uri Api.Object.User
...
contributionsCollection :
    ...
    -> SelectionSet decodesTo Api.Object.ContributionsCollection
    -> SelectionSet decodesTo Api.Object.User
contributionsCollection fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "organizationID" filledInOptionals____.organizationID (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId), Argument.optional "from" filledInOptionals____.from (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime), Argument.optional "to" filledInOptionals____.to (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) ]
                |> List.filterMap Basics.identity
    in
...
-}
estimatedNextSponsorsPayoutInCents : SelectionSet Int Api.Object.User
...
followers :
    ...
    -> SelectionSet decodesTo Api.Object.FollowerConnection
    -> SelectionSet decodesTo Api.Object.User
...
following :
    ...
    -> SelectionSet decodesTo Api.Object.FollowingConnection
    -> SelectionSet decodesTo Api.Object.User
...
-}
hasSponsorsListing : SelectionSet Bool Api.Object.User
hasSponsorsListing =
...
hovercard fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "primarySubjectId" filledInOptionals____.primarySubjectId (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) ]
                |> List.filterMap Basics.identity
    in
...
-}
isFollowingViewer : SelectionSet Bool Api.Object.User
isFollowingViewer =
...
-}
isGitHubStar : SelectionSet Bool Api.Object.User
isGitHubStar =
...
-}
isSponsoringViewer : SelectionSet Bool Api.Object.User
isSponsoringViewer =
...
-}
monthlyEstimatedSponsorsIncomeInCents : SelectionSet Int Api.Object.User
...
organizationVerifiedDomainEmails :
    ...
    -> SelectionSet (List String) Api.Object.User
...
repositoriesContributedTo fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "privacy" filledInOptionals____.privacy (Encode.enum Api.Enum.RepositoryPrivacy.toString), Argument.optional "orderBy" filledInOptionals____.orderBy Api.InputObject.encodeRepositoryOrder, Argument.optional "isLocked" filledInOptionals____.isLocked Encode.bool, Argument.optional "includeUserRepositories" filledInOptionals____.includeUserRepositories Encode.bool, Argument.optional "contributionTypes" filledInOptionals____.contributionTypes (Encode.enum Api.Enum.RepositoryContributionType.toString |> Encode.maybe |> Encode.list), Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int ]
                |> List.filterMap Basics.identity
    in
...
savedReplies :
    ...
    -> SelectionSet decodesTo Api.Object.SavedReplyConnection
    -> SelectionSet (Maybe decodesTo) Api.Object.User
...
starredRepositories :
    ...
    -> SelectionSet decodesTo Api.Object.StarredRepositoryConnection
    -> SelectionSet decodesTo Api.Object.User
...
-}
status :
    SelectionSet decodesTo Api.Object.UserStatus
    -> SelectionSet (Maybe decodesTo) Api.Object.User
status object____ =
...
topRepositories fillInOptionals____ requiredArgs____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int, Argument.optional "since" filledInOptionals____.since (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) ]
                |> List.filterMap Basics.identity
    in
    Object.selectionForCompositeField "topRepositories" (optionalArgs____ ++ [ Argument.required "orderBy" requiredArgs____.orderBy Api.InputObject.encodeRepositoryOrder ]) object____ Basics.identity


{-| The user's Twitter username.
-}
twitterUsername : SelectionSet (Maybe String) Api.Object.User
twitterUsername =
...
-}
viewerCanSponsor : SelectionSet Bool Api.Object.User
viewerCanSponsor =
...
-}
viewerIsSponsoring : SelectionSet Bool Api.Object.User
viewerIsSponsoring =
