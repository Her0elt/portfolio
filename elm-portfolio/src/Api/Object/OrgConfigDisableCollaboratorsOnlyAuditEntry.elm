...
module Api.Object.OrgConfigDisableCollaboratorsOnlyAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.OrgConfigDisableCollaboratorsOnlyAuditEntry
actor object____ =
