...
module Api.Object.DeploymentRequest exposing (..)
...
-}
currentUserCanApprove : SelectionSet Bool Api.Object.DeploymentRequest
...
-}
waitTimer : SelectionSet Int Api.Object.DeploymentRequest
waitTimer =
...
{-| The wait timer in minutes configured in the environment
-}
waitTimerStartedAt : SelectionSet (Maybe Api.ScalarCodecs.DateTime) Api.Object.DeploymentRequest
waitTimerStartedAt =
    Object.selectionForField "(Maybe ScalarCodecs.DateTime)" "waitTimerStartedAt" [] (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapCodecs |> .codecDateTime |> .decoder |> Decode.nullable)
