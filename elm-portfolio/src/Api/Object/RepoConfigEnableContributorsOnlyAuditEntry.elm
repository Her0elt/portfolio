...
module Api.Object.RepoConfigEnableContributorsOnlyAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepoConfigEnableContributorsOnlyAuditEntry
actor object____ =
