...
module Api.Object.OrganizationMemberConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.OrganizationMemberEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.OrganizationMemberConnection
edges object____ =
