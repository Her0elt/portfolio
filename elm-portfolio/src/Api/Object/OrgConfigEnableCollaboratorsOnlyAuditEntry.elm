...
module Api.Object.OrgConfigEnableCollaboratorsOnlyAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.OrgConfigEnableCollaboratorsOnlyAuditEntry
actor object____ =
