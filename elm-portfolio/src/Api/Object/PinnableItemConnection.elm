...
module Api.Object.PinnableItemConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.PinnableItemEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.PinnableItemConnection
edges object____ =
