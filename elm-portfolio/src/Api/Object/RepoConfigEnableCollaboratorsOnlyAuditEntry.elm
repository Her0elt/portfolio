...
module Api.Object.RepoConfigEnableCollaboratorsOnlyAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepoConfigEnableCollaboratorsOnlyAuditEntry
actor object____ =
