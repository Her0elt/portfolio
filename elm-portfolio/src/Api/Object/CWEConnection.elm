...
module Api.Object.CWEConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Api.Object.CWEEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.CWEConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Api.Object.Cwe
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.CWEConnection
nodes object____ =
...
-}
totalCount : SelectionSet Int Api.Object.CWEConnection
totalCount =
