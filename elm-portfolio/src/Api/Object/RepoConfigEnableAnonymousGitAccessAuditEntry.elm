...
module Api.Object.RepoConfigEnableAnonymousGitAccessAuditEntry exposing (..)
...
actor :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Object.RepoConfigEnableAnonymousGitAccessAuditEntry
actor object____ =
