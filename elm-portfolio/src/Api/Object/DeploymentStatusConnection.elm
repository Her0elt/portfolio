...
-}
edges :
    SelectionSet decodesTo Api.Object.DeploymentStatusEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DeploymentStatusConnection
edges object____ =
...
pageInfo :
    ...
    -> SelectionSet decodesTo Api.Object.DeploymentStatusConnection
pageInfo object____ =
