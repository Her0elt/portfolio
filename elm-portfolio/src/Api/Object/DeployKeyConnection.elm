...
-}
edges :
    SelectionSet decodesTo Api.Object.DeployKeyEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DeployKeyConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Api.Object.DeployKey
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.DeployKeyConnection
nodes object____ =
