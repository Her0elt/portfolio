...
avatarUrl :
    ...
    -> SelectionSet (Maybe Api.ScalarCodecs.Uri) Api.Object.Team
...
-}
databaseId : SelectionSet (Maybe Int) Api.Object.Team
databaseId =
...
discussion :
    ...
    -> SelectionSet decodesTo Api.Object.TeamDiscussion
    -> SelectionSet (Maybe decodesTo) Api.Object.Team
...
discussions :
    ...
    -> SelectionSet decodesTo Api.Object.TeamDiscussionConnection
    -> SelectionSet decodesTo Api.Object.Team
...
invitations :
    ...
    -> SelectionSet decodesTo Api.Object.OrganizationInvitationConnection
    -> SelectionSet (Maybe decodesTo) Api.Object.Team
...
members :
    ...
    -> SelectionSet decodesTo Api.Object.TeamMemberConnection
    -> SelectionSet decodesTo Api.Object.Team
members fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int, Argument.optional "query" filledInOptionals____.query Encode.string, Argument.optional "membership" filledInOptionals____.membership (Encode.enum Api.Enum.TeamMembershipType.toString), Argument.optional "role" filledInOptionals____.role (Encode.enum Api.Enum.TeamMemberRole.toString), Argument.optional "orderBy" filledInOptionals____.orderBy Api.InputObject.encodeTeamMemberOrder ]
                |> List.filterMap Basics.identity
    in
...
repositories :
    ...
    -> SelectionSet decodesTo Api.Object.TeamRepositoryConnection
    -> SelectionSet decodesTo Api.Object.Team
