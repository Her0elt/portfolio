...
import Api.Enum.DiscussionOrderField
import Api.Enum.DiscussionPollOptionOrderField
import Api.Enum.DismissReason
...
import Api.Enum.IpAllowListEntryOrderField
import Api.Enum.IpAllowListForInstalledAppsEnabledSettingValue
import Api.Enum.IssueClosedStateReason
import Api.Enum.IssueCommentOrderField
...
import Api.Enum.MigrationSourceType
import Api.Enum.MilestoneOrderField
import Api.Enum.NotificationRestrictionSettingValue
import Api.Enum.OrderDirection
import Api.Enum.OrgEnterpriseOwnerOrderField
import Api.Enum.OrganizationOrderField
import Api.Enum.PackageFileOrderField
import Api.Enum.PackageOrderField
import Api.Enum.PackageVersionOrderField
import Api.Enum.ProjectOrderField
import Api.Enum.ProjectState
import Api.Enum.ProjectTemplate
import Api.Enum.ProjectV2FieldOrderField
import Api.Enum.ProjectV2ItemFieldValueOrderField
import Api.Enum.ProjectV2ItemOrderField
import Api.Enum.ProjectV2OrderField
import Api.Enum.ProjectV2ViewOrderField
...
import Api.Enum.ReportedContentClassifiers
import Api.Enum.RepositoryInteractionLimit
import Api.Enum.RepositoryInteractionLimitExpiry
import Api.Enum.RepositoryInvitationOrderField
import Api.Enum.RepositoryMigrationOrderDirection
import Api.Enum.RepositoryMigrationOrderField
import Api.Enum.RepositoryOrderField
import Api.Enum.RepositoryPermission
import Api.Enum.RepositoryVisibility
import Api.Enum.RequestableCheckStatusState
...
import Api.Enum.SponsorOrderField
import Api.Enum.SponsorableOrderField
import Api.Enum.SponsorsActivityOrderField
import Api.Enum.SponsorsTierOrderField
import Api.Enum.SponsorshipNewsletterOrderField
...
import Api.Enum.VerifiableDomainOrderField
import Api.Enum.WorkflowRunOrderField
...
encodeAbortQueuedMigrationsInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAcceptEnterpriseAdministratorInvitationInput input____ =
    Encode.maybeObject
        [ ( "invitationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.invitationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAcceptTopicSuggestionInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddAssigneesToAssignableInput input____ =
    Encode.maybeObject
        [ ( "assignableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.assignableId |> Just ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) input____.assigneeIds |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddCommentInput input____ =
    Encode.maybeObject
        [ ( "subjectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.subjectId |> Just ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias AddDiscussionCommentInputOptionalFields =
    { replyToId : OptionalArgument Api.ScalarCodecs.Id
    , clientMutationId : OptionalArgument String
    }
...
encodeAddDiscussionCommentInput input____ =
    Encode.maybeObject
        [ ( "discussionId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.discussionId |> Just ), ( "replyToId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.replyToId ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias AddDiscussionPollVoteInputRequiredFields =
    { pollOptionId : Api.ScalarCodecs.Id }
...
encodeAddDiscussionPollVoteInput input____ =
    Encode.maybeObject
        [ ( "pollOptionId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pollOptionId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddEnterpriseSupportEntitlementInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "login", Encode.string input____.login |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddLabelsToLabelableInput input____ =
    Encode.maybeObject
        [ ( "labelableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.labelableId |> Just ), ( "labelIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) input____.labelIds |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddProjectCardInput input____ =
    Encode.maybeObject
        [ ( "projectColumnId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectColumnId |> Just ), ( "contentId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.contentId ), ( "note", Encode.string |> Encode.optional input____.note ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddProjectColumnInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias AddProjectDraftIssueInputOptionalFields =
    { projectId : OptionalArgument Api.ScalarCodecs.Id
...
encodeAddProjectDraftIssueInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.projectId ), ( "title", Encode.string |> Encode.optional input____.title ), ( "body", Encode.string |> Encode.optional input____.body ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.assigneeIds ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddProjectNextItemInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.projectId ), ( "contentId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.contentId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddProjectV2DraftIssueInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "title", Encode.string input____.title |> Just ), ( "body", Encode.string |> Encode.optional input____.body ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.assigneeIds ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddProjectV2ItemByIdInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "contentId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.contentId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddPullRequestReviewCommentInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.pullRequestId ), ( "pullRequestReviewId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.pullRequestReviewId ), ( "commitOID", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input____.commitOID ), ( "body", Encode.string input____.body |> Just ), ( "path", Encode.string |> Encode.optional input____.path ), ( "position", Encode.int |> Encode.optional input____.position ), ( "inReplyTo", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.inReplyTo ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddPullRequestReviewInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "commitOID", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input____.commitOID ), ( "body", Encode.string |> Encode.optional input____.body ), ( "event", Encode.enum Api.Enum.PullRequestReviewEvent.toString |> Encode.optional input____.event ), ( "comments", (encodeDraftPullRequestReviewComment |> Encode.maybe |> Encode.list) |> Encode.optional input____.comments ), ( "threads", (encodeDraftPullRequestReviewThread |> Encode.maybe |> Encode.list) |> Encode.optional input____.threads ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias AddPullRequestReviewThreadInputOptionalFields =
    { pullRequestId : OptionalArgument Api.ScalarCodecs.Id
    , pullRequestReviewId : OptionalArgument Api.ScalarCodecs.Id
    , side : OptionalArgument Api.Enum.DiffSide.DiffSide
    , startLine : OptionalArgument Int
    , startSide : OptionalArgument Api.Enum.DiffSide.DiffSide
    , clientMutationId : OptionalArgument String
    }
...
encodeAddPullRequestReviewThreadInput input____ =
    Encode.maybeObject
        [ ( "path", Encode.string input____.path |> Just ), ( "body", Encode.string input____.body |> Just ), ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.pullRequestId ), ( "pullRequestReviewId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.pullRequestReviewId ), ( "line", Encode.int input____.line |> Just ), ( "side", Encode.enum Api.Enum.DiffSide.toString |> Encode.optional input____.side ), ( "startLine", Encode.int |> Encode.optional input____.startLine ), ( "startSide", Encode.enum Api.Enum.DiffSide.toString |> Encode.optional input____.startSide ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddReactionInput input____ =
    Encode.maybeObject
        [ ( "subjectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.subjectId |> Just ), ( "content", Encode.enum Api.Enum.ReactionContent.toString input____.content |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddStarInput input____ =
    Encode.maybeObject
        [ ( "starrableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.starrableId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddUpvoteInput input____ =
    Encode.maybeObject
        [ ( "subjectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.subjectId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAddVerifiableDomainInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "domain", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) input____.domain |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias ApproveDeploymentsInputRequiredFields =
    { workflowRunId : Api.ScalarCodecs.Id
    , environmentIds : List Api.ScalarCodecs.Id
    }
...
encodeApproveDeploymentsInput input____ =
    Encode.maybeObject
        [ ( "workflowRunId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.workflowRunId |> Just ), ( "environmentIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) input____.environmentIds |> Just ), ( "comment", Encode.string |> Encode.optional input____.comment ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeApproveVerifiableDomainInput input____ =
    Encode.maybeObject
        [ ( "id", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.id |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeArchiveRepositoryInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeAuditLogOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.AuditLogOrderField.toString |> Encode.optional input____.field ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString |> Encode.optional input____.direction ) ]
...
type alias CancelSponsorshipInputOptionalFields =
    { sponsorId : OptionalArgument Api.ScalarCodecs.Id
    , sponsorLogin : OptionalArgument String
    , sponsorableId : OptionalArgument Api.ScalarCodecs.Id
...
encodeCancelSponsorshipInput input____ =
    Encode.maybeObject
        [ ( "sponsorId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorId ), ( "sponsorLogin", Encode.string |> Encode.optional input____.sponsorLogin ), ( "sponsorableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorableId ), ( "sponsorableLogin", Encode.string |> Encode.optional input____.sponsorableLogin ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeChangeUserStatusInput input____ =
    Encode.maybeObject
        [ ( "emoji", Encode.string |> Encode.optional input____.emoji ), ( "message", Encode.string |> Encode.optional input____.message ), ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.organizationId ), ( "limitedAvailability", Encode.bool |> Encode.optional input____.limitedAvailability ), ( "expiresAt", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.expiresAt ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CheckAnnotationDataRequiredFields =
    ...
    , annotationLevel : Api.Enum.CheckAnnotationLevel.CheckAnnotationLevel
    , message : String
    }
...
type alias CheckRunFilterOptionalFields =
    { checkType : OptionalArgument Api.Enum.CheckRunType.CheckRunType
    , appId : OptionalArgument Int
    , checkName : OptionalArgument String
    , status : OptionalArgument Api.Enum.CheckStatusState.CheckStatusState
    , statuses : OptionalArgument (List Api.Enum.CheckStatusState.CheckStatusState)
    , conclusions : OptionalArgument (List Api.Enum.CheckConclusionState.CheckConclusionState)
    }
...
encodeCheckRunFilter input____ =
    Encode.maybeObject
        [ ( "checkType", Encode.enum Api.Enum.CheckRunType.toString |> Encode.optional input____.checkType ), ( "appId", Encode.int |> Encode.optional input____.appId ), ( "checkName", Encode.string |> Encode.optional input____.checkName ), ( "status", Encode.enum Api.Enum.CheckStatusState.toString |> Encode.optional input____.status ), ( "statuses", (Encode.enum Api.Enum.CheckStatusState.toString |> Encode.list) |> Encode.optional input____.statuses ), ( "conclusions", (Encode.enum Api.Enum.CheckConclusionState.toString |> Encode.list) |> Encode.optional input____.conclusions ) ]
...
encodeCheckRunOutputImage input____ =
    Encode.maybeObject
        [ ( "alt", Encode.string input____.alt |> Just ), ( "imageUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) input____.imageUrl |> Just ), ( "caption", Encode.string |> Encode.optional input____.caption ) ]
...
encodeCheckSuiteAutoTriggerPreference input____ =
    Encode.maybeObject
        [ ( "appId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.appId |> Just ), ( "setting", Encode.bool input____.setting |> Just ) ]
...
encodeClearLabelsFromLabelableInput input____ =
    Encode.maybeObject
        [ ( "labelableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.labelableId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeClearProjectV2ItemFieldValueInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "itemId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.itemId |> Just ), ( "fieldId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.fieldId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCloneProjectInput input____ =
    Encode.maybeObject
        [ ( "targetOwnerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.targetOwnerId |> Just ), ( "sourceId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.sourceId |> Just ), ( "includeWorkflows", Encode.bool input____.includeWorkflows |> Just ), ( "name", Encode.string input____.name |> Just ), ( "body", Encode.string |> Encode.optional input____.body ), ( "public", Encode.bool |> Encode.optional input____.public ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCloneTemplateRepositoryInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "description", Encode.string |> Encode.optional input____.description ), ( "visibility", Encode.enum Api.Enum.RepositoryVisibility.toString input____.visibility |> Just ), ( "includeAllBranches", Encode.bool |> Encode.optional input____.includeAllBranches ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CloseIssueInputOptionalFields =
    { stateReason : OptionalArgument Api.Enum.IssueClosedStateReason.IssueClosedStateReason
    , clientMutationId : OptionalArgument String
    }
...
encodeCloseIssueInput input____ =
    Encode.maybeObject
        [ ( "issueId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.issueId |> Just ), ( "stateReason", Encode.enum Api.Enum.IssueClosedStateReason.toString |> Encode.optional input____.stateReason ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeClosePullRequestInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCommitAuthor input____ =
    Encode.maybeObject
        [ ( "id", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "emails", (Encode.string |> Encode.list) |> Encode.optional input____.emails ) ]
...
encodeCommitContributionOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.CommitContributionOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeCommittableBranch input____ =
    Encode.maybeObject
        [ ( "id", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "repositoryNameWithOwner", Encode.string |> Encode.optional input____.repositoryNameWithOwner ), ( "branchName", Encode.string |> Encode.optional input____.branchName ) ]
...
encodeContributionOrder input____ =
    Encode.maybeObject
        [ ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeConvertProjectCardNoteToIssueInput input____ =
    Encode.maybeObject
        [ ( "projectCardId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectCardId |> Just ), ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "title", Encode.string |> Encode.optional input____.title ), ( "body", Encode.string |> Encode.optional input____.body ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CreateBranchProtectionRuleInputOptionalFields =
    ...
    , bypassPullRequestActorIds : OptionalArgument (List Api.ScalarCodecs.Id)
    , bypassForcePushActorIds : OptionalArgument (List Api.ScalarCodecs.Id)
...
encodeCreateBranchProtectionRuleInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "pattern", Encode.string input____.pattern |> Just ), ( "requiresApprovingReviews", Encode.bool |> Encode.optional input____.requiresApprovingReviews ), ( "requiredApprovingReviewCount", Encode.int |> Encode.optional input____.requiredApprovingReviewCount ), ( "requiresCommitSignatures", Encode.bool |> Encode.optional input____.requiresCommitSignatures ), ( "requiresLinearHistory", Encode.bool |> Encode.optional input____.requiresLinearHistory ), ( "blocksCreations", Encode.bool |> Encode.optional input____.blocksCreations ), ( "allowsForcePushes", Encode.bool |> Encode.optional input____.allowsForcePushes ), ( "allowsDeletions", Encode.bool |> Encode.optional input____.allowsDeletions ), ( "isAdminEnforced", Encode.bool |> Encode.optional input____.isAdminEnforced ), ( "requiresStatusChecks", Encode.bool |> Encode.optional input____.requiresStatusChecks ), ( "requiresStrictStatusChecks", Encode.bool |> Encode.optional input____.requiresStrictStatusChecks ), ( "requiresCodeOwnerReviews", Encode.bool |> Encode.optional input____.requiresCodeOwnerReviews ), ( "dismissesStaleReviews", Encode.bool |> Encode.optional input____.dismissesStaleReviews ), ( "restrictsReviewDismissals", Encode.bool |> Encode.optional input____.restrictsReviewDismissals ), ( "reviewDismissalActorIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.reviewDismissalActorIds ), ( "bypassPullRequestActorIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.bypassPullRequestActorIds ), ( "bypassForcePushActorIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.bypassForcePushActorIds ), ( "restrictsPushes", Encode.bool |> Encode.optional input____.restrictsPushes ), ( "pushActorIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.pushActorIds ), ( "requiredStatusCheckContexts", (Encode.string |> Encode.list) |> Encode.optional input____.requiredStatusCheckContexts ), ( "requiredStatusChecks", (encodeRequiredStatusCheckInput |> Encode.list) |> Encode.optional input____.requiredStatusChecks ), ( "requiresConversationResolution", Encode.bool |> Encode.optional input____.requiresConversationResolution ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CreateCheckRunInputRequiredFields =
    { repositoryId : Api.ScalarCodecs.Id
    , name : String
    , headSha : Api.ScalarCodecs.GitObjectID
    }


type alias CreateCheckRunInputOptionalFields =
    { detailsUrl : OptionalArgument Api.ScalarCodecs.Uri
    , externalId : OptionalArgument String
    , status : OptionalArgument Api.Enum.RequestableCheckStatusState.RequestableCheckStatusState
    , startedAt : OptionalArgument Api.ScalarCodecs.DateTime
    , conclusion : OptionalArgument Api.Enum.CheckConclusionState.CheckConclusionState
    , completedAt : OptionalArgument Api.ScalarCodecs.DateTime
...
encodeCreateCheckRunInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "headSha", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) input____.headSha |> Just ), ( "detailsUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) |> Encode.optional input____.detailsUrl ), ( "externalId", Encode.string |> Encode.optional input____.externalId ), ( "status", Encode.enum Api.Enum.RequestableCheckStatusState.toString |> Encode.optional input____.status ), ( "startedAt", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.startedAt ), ( "conclusion", Encode.enum Api.Enum.CheckConclusionState.toString |> Encode.optional input____.conclusion ), ( "completedAt", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.completedAt ), ( "output", encodeCheckRunOutput |> Encode.optional input____.output ), ( "actions", (encodeCheckRunAction |> Encode.list) |> Encode.optional input____.actions ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateCheckSuiteInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "headSha", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) input____.headSha |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CreateCommitOnBranchInputRequiredFields =
    ...
    , expectedHeadOid : Api.ScalarCodecs.GitObjectID
    }
...
encodeCreateCommitOnBranchInput input____ =
    Encode.maybeObject
        [ ( "branch", encodeCommittableBranch input____.branch |> Just ), ( "fileChanges", encodeFileChanges |> Encode.optional input____.fileChanges ), ( "message", encodeCommitMessage input____.message |> Just ), ( "expectedHeadOid", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) input____.expectedHeadOid |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateDiscussionInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "title", Encode.string input____.title |> Just ), ( "body", Encode.string input____.body |> Just ), ( "categoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.categoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateEnterpriseOrganizationInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "login", Encode.string input____.login |> Just ), ( "profileName", Encode.string input____.profileName |> Just ), ( "billingEmail", Encode.string input____.billingEmail |> Just ), ( "adminLogins", (Encode.string |> Encode.list) input____.adminLogins |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateIpAllowListEntryInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "allowListValue", Encode.string input____.allowListValue |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "isActive", Encode.bool input____.isActive |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateIssueInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "title", Encode.string input____.title |> Just ), ( "body", Encode.string |> Encode.optional input____.body ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.assigneeIds ), ( "milestoneId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.milestoneId ), ( "labelIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.labelIds ), ( "projectIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.projectIds ), ( "issueTemplate", Encode.string |> Encode.optional input____.issueTemplate ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateLinkedBranchInput input____ =
    Encode.maybeObject
        [ ( "issueId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.issueId |> Just ), ( "oid", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) input____.oid |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.repositoryId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CreateMigrationSourceInputRequiredFields =
    { name : String
    , url : String
    , type_ : Api.Enum.MigrationSourceType.MigrationSourceType
    , ownerId : Api.ScalarCodecs.Id
    }
...
encodeCreateMigrationSourceInput input____ =
    Encode.maybeObject
        [ ( "name", Encode.string input____.name |> Just ), ( "url", Encode.string input____.url |> Just ), ( "accessToken", Encode.string |> Encode.optional input____.accessToken ), ( "type", Encode.enum Api.Enum.MigrationSourceType.toString input____.type_ |> Just ), ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "githubPat", Encode.string |> Encode.optional input____.githubPat ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateProjectInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "body", Encode.string |> Encode.optional input____.body ), ( "template", Encode.enum Api.Enum.ProjectTemplate.toString |> Encode.optional input____.template ), ( "repositoryIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.repositoryIds ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateProjectV2Input input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "title", Encode.string input____.title |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateRefInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "oid", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) input____.oid |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateRepositoryInput input____ =
    Encode.maybeObject
        [ ( "name", Encode.string input____.name |> Just ), ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.ownerId ), ( "description", Encode.string |> Encode.optional input____.description ), ( "visibility", Encode.enum Api.Enum.RepositoryVisibility.toString input____.visibility |> Just ), ( "template", Encode.bool |> Encode.optional input____.template ), ( "homepageUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) |> Encode.optional input____.homepageUrl ), ( "hasWikiEnabled", Encode.bool |> Encode.optional input____.hasWikiEnabled ), ( "hasIssuesEnabled", Encode.bool |> Encode.optional input____.hasIssuesEnabled ), ( "teamId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.teamId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateSponsorsTierInput input____ =
    Encode.maybeObject
        [ ( "sponsorableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorableId ), ( "sponsorableLogin", Encode.string |> Encode.optional input____.sponsorableLogin ), ( "amount", Encode.int input____.amount |> Just ), ( "isRecurring", Encode.bool |> Encode.optional input____.isRecurring ), ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.repositoryId ), ( "repositoryOwnerLogin", Encode.string |> Encode.optional input____.repositoryOwnerLogin ), ( "repositoryName", Encode.string |> Encode.optional input____.repositoryName ), ( "welcomeMessage", Encode.string |> Encode.optional input____.welcomeMessage ), ( "description", Encode.string input____.description |> Just ), ( "publish", Encode.bool |> Encode.optional input____.publish ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias CreateSponsorshipInputOptionalFields =
    ...
    , privacyLevel : OptionalArgument Api.Enum.SponsorshipPrivacy.SponsorshipPrivacy
    , clientMutationId : OptionalArgument String
    }
...
encodeCreateSponsorshipInput input____ =
    Encode.maybeObject
        [ ( "sponsorId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorId ), ( "sponsorLogin", Encode.string |> Encode.optional input____.sponsorLogin ), ( "sponsorableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorableId ), ( "sponsorableLogin", Encode.string |> Encode.optional input____.sponsorableLogin ), ( "tierId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.tierId ), ( "amount", Encode.int |> Encode.optional input____.amount ), ( "isRecurring", Encode.bool |> Encode.optional input____.isRecurring ), ( "receiveEmails", Encode.bool |> Encode.optional input____.receiveEmails ), ( "privacyLevel", Encode.enum Api.Enum.SponsorshipPrivacy.toString |> Encode.optional input____.privacyLevel ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateTeamDiscussionCommentInput input____ =
    Encode.maybeObject
        [ ( "discussionId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.discussionId |> Just ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeCreateTeamDiscussionInput input____ =
    Encode.maybeObject
        [ ( "teamId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.teamId |> Just ), ( "title", Encode.string input____.title |> Just ), ( "body", Encode.string input____.body |> Just ), ( "private", Encode.bool |> Encode.optional input____.private ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeclineTopicSuggestionInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "reason", Encode.enum Api.Enum.TopicSuggestionDeclineReason.toString input____.reason |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteBranchProtectionRuleInput input____ =
    Encode.maybeObject
        [ ( "branchProtectionRuleId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.branchProtectionRuleId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias DeleteIpAllowListEntryInputRequiredFields =
    { ipAllowListEntryId : Api.ScalarCodecs.Id }
...
encodeDeleteIpAllowListEntryInput input____ =
    Encode.maybeObject
        [ ( "ipAllowListEntryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ipAllowListEntryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteIssueInput input____ =
    Encode.maybeObject
        [ ( "issueId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.issueId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias DeleteLinkedBranchInputRequiredFields =
    { linkedBranchId : Api.ScalarCodecs.Id }
...
encodeDeleteLinkedBranchInput input____ =
    Encode.maybeObject
        [ ( "linkedBranchId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.linkedBranchId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteProjectCardInput input____ =
    Encode.maybeObject
        [ ( "cardId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.cardId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteProjectColumnInput input____ =
    Encode.maybeObject
        [ ( "columnId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.columnId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteProjectInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteProjectNextItemInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.projectId ), ( "itemId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.itemId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteProjectV2ItemInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "itemId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.itemId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeletePullRequestReviewInput input____ =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestReviewId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeleteRefInput input____ =
    Encode.maybeObject
        [ ( "refId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.refId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDeploymentOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.DeploymentOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias DiscussionOrderRequiredFields =
    { field : Api.Enum.DiscussionOrderField.DiscussionOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeDiscussionOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.DiscussionOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias DiscussionPollOptionOrderRequiredFields =
    { field : Api.Enum.DiscussionPollOptionOrderField.DiscussionPollOptionOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeDiscussionPollOptionOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.DiscussionPollOptionOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeDismissPullRequestReviewInput input____ =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestReviewId |> Just ), ( "message", Encode.string input____.message |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias DismissRepositoryVulnerabilityAlertInputRequiredFields =
    { repositoryVulnerabilityAlertId : Api.ScalarCodecs.Id
    , dismissReason : Api.Enum.DismissReason.DismissReason
    }
...
encodeDismissRepositoryVulnerabilityAlertInput input____ =
    Encode.maybeObject
        [ ( "repositoryVulnerabilityAlertId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryVulnerabilityAlertId |> Just ), ( "dismissReason", Encode.enum Api.Enum.DismissReason.toString input____.dismissReason |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeDraftPullRequestReviewThread input____ =
    Encode.maybeObject
        [ ( "path", Encode.string input____.path |> Just ), ( "line", Encode.int input____.line |> Just ), ( "side", Encode.enum Api.Enum.DiffSide.toString |> Encode.optional input____.side ), ( "startLine", Encode.int |> Encode.optional input____.startLine ), ( "startSide", Encode.enum Api.Enum.DiffSide.toString |> Encode.optional input____.startSide ), ( "body", Encode.string input____.body |> Just ) ]
...
encodeEnablePullRequestAutoMergeInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "commitHeadline", Encode.string |> Encode.optional input____.commitHeadline ), ( "commitBody", Encode.string |> Encode.optional input____.commitBody ), ( "mergeMethod", Encode.enum Api.Enum.PullRequestMergeMethod.toString |> Encode.optional input____.mergeMethod ), ( "authorEmail", Encode.string |> Encode.optional input____.authorEmail ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeEnterpriseAdministratorInvitationOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.EnterpriseAdministratorInvitationOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeEnterpriseMemberOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.EnterpriseMemberOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeEnterpriseServerInstallationOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.EnterpriseServerInstallationOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeEnterpriseServerUserAccountEmailOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.EnterpriseServerUserAccountEmailOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeEnterpriseServerUserAccountOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.EnterpriseServerUserAccountOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeEnterpriseServerUserAccountsUploadOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.EnterpriseServerUserAccountsUploadOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias FileAdditionRequiredFields =
    { path : String
    , contents : Api.ScalarCodecs.Base64String
    }
...
encodeFileAddition input____ =
    Encode.maybeObject
        [ ( "path", Encode.string input____.path |> Just ), ( "contents", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecBase64String) input____.contents |> Just ) ]
...
encodeFollowOrganizationInput input____ =
    Encode.maybeObject
        [ ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeFollowUserInput input____ =
    Encode.maybeObject
        [ ( "userId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.userId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeGistOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.GistOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias GrantMigratorRoleInputRequiredFields =
    { organizationId : Api.ScalarCodecs.Id
    , actor : String
    , actorType : Api.Enum.ActorType.ActorType
    }
...
encodeGrantMigratorRoleInput input____ =
    Encode.maybeObject
        [ ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "actor", Encode.string input____.actor |> Just ), ( "actorType", Encode.enum Api.Enum.ActorType.toString input____.actorType |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeInviteEnterpriseAdminInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "invitee", Encode.string |> Encode.optional input____.invitee ), ( "email", Encode.string |> Encode.optional input____.email ), ( "role", Encode.enum Api.Enum.EnterpriseAdministratorRole.toString |> Encode.optional input____.role ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias IpAllowListEntryOrderRequiredFields =
    { field : Api.Enum.IpAllowListEntryOrderField.IpAllowListEntryOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeIpAllowListEntryOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.IpAllowListEntryOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias IssueCommentOrderRequiredFields =
    { field : Api.Enum.IssueCommentOrderField.IssueCommentOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeIssueCommentOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.IssueCommentOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeIssueFilters input____ =
    Encode.maybeObject
        [ ( "assignee", Encode.string |> Encode.optional input____.assignee ), ( "createdBy", Encode.string |> Encode.optional input____.createdBy ), ( "labels", (Encode.string |> Encode.list) |> Encode.optional input____.labels ), ( "mentioned", Encode.string |> Encode.optional input____.mentioned ), ( "milestone", Encode.string |> Encode.optional input____.milestone ), ( "milestoneNumber", Encode.string |> Encode.optional input____.milestoneNumber ), ( "since", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.since ), ( "states", (Encode.enum Api.Enum.IssueState.toString |> Encode.list) |> Encode.optional input____.states ), ( "viewerSubscribed", Encode.bool |> Encode.optional input____.viewerSubscribed ) ]
...
encodeIssueOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.IssueOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeLabelOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.LabelOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeLanguageOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.LanguageOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeLinkRepositoryToProjectInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeLockLockableInput input____ =
    Encode.maybeObject
        [ ( "lockableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.lockableId |> Just ), ( "lockReason", Encode.enum Api.Enum.LockReason.toString |> Encode.optional input____.lockReason ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeMarkFileAsViewedInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "path", Encode.string input____.path |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeMergePullRequestInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "commitHeadline", Encode.string |> Encode.optional input____.commitHeadline ), ( "commitBody", Encode.string |> Encode.optional input____.commitBody ), ( "expectedHeadOid", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input____.expectedHeadOid ), ( "mergeMethod", Encode.enum Api.Enum.PullRequestMergeMethod.toString |> Encode.optional input____.mergeMethod ), ( "authorEmail", Encode.string |> Encode.optional input____.authorEmail ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeMilestoneOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.MilestoneOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias MinimizeCommentInputRequiredFields =
    { subjectId : Api.ScalarCodecs.Id
    , classifier : Api.Enum.ReportedContentClassifiers.ReportedContentClassifiers
    }
...
encodeMinimizeCommentInput input____ =
    Encode.maybeObject
        [ ( "subjectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.subjectId |> Just ), ( "classifier", Encode.enum Api.Enum.ReportedContentClassifiers.toString input____.classifier |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeMoveProjectCardInput input____ =
    Encode.maybeObject
        [ ( "cardId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.cardId |> Just ), ( "columnId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.columnId |> Just ), ( "afterCardId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.afterCardId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeMoveProjectColumnInput input____ =
    Encode.maybeObject
        [ ( "columnId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.columnId |> Just ), ( "afterColumnId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.afterColumnId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias OrgEnterpriseOwnerOrderRequiredFields =
    { field : Api.Enum.OrgEnterpriseOwnerOrderField.OrgEnterpriseOwnerOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeOrgEnterpriseOwnerOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.OrgEnterpriseOwnerOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeOrganizationOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.OrganizationOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias PackageFileOrderOptionalFields =
    { field : OptionalArgument Api.Enum.PackageFileOrderField.PackageFileOrderField
    , direction : OptionalArgument Api.Enum.OrderDirection.OrderDirection
    }
...
encodePackageFileOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.PackageFileOrderField.toString |> Encode.optional input____.field ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString |> Encode.optional input____.direction ) ]
...
type alias PackageOrderOptionalFields =
    { field : OptionalArgument Api.Enum.PackageOrderField.PackageOrderField
    , direction : OptionalArgument Api.Enum.OrderDirection.OrderDirection
    }
...
encodePackageOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.PackageOrderField.toString |> Encode.optional input____.field ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString |> Encode.optional input____.direction ) ]
...
type alias PackageVersionOrderOptionalFields =
    { field : OptionalArgument Api.Enum.PackageVersionOrderField.PackageVersionOrderField
    , direction : OptionalArgument Api.Enum.OrderDirection.OrderDirection
    }
...
encodePackageVersionOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.PackageVersionOrderField.toString |> Encode.optional input____.field ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString |> Encode.optional input____.direction ) ]
...
encodeProjectOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ProjectOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias ProjectV2FieldOrderRequiredFields =
    { field : Api.Enum.ProjectV2FieldOrderField.ProjectV2FieldOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeProjectV2FieldOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ProjectV2FieldOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeProjectV2FieldValue input____ =
    Encode.maybeObject
        [ ( "text", Encode.string |> Encode.optional input____.text ), ( "number", Encode.float |> Encode.optional input____.number ), ( "date", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDate) |> Encode.optional input____.date ), ( "singleSelectOptionId", Encode.string |> Encode.optional input____.singleSelectOptionId ), ( "iterationId", Encode.string |> Encode.optional input____.iterationId ) ]
...
type alias ProjectV2ItemFieldValueOrderRequiredFields =
    { field : Api.Enum.ProjectV2ItemFieldValueOrderField.ProjectV2ItemFieldValueOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeProjectV2ItemFieldValueOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ProjectV2ItemFieldValueOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias ProjectV2ItemOrderRequiredFields =
    { field : Api.Enum.ProjectV2ItemOrderField.ProjectV2ItemOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeProjectV2ItemOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ProjectV2ItemOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias ProjectV2OrderRequiredFields =
    { field : Api.Enum.ProjectV2OrderField.ProjectV2OrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeProjectV2Order input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ProjectV2OrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias ProjectV2ViewOrderRequiredFields =
    { field : Api.Enum.ProjectV2ViewOrderField.ProjectV2ViewOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeProjectV2ViewOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ProjectV2ViewOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodePullRequestOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.PullRequestOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeReactionOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ReactionOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeRefOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.RefOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeRegenerateEnterpriseIdentityProviderRecoveryCodesInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeReleaseOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.ReleaseOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeRemoveEnterpriseOrganizationInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeRemoveOutsideCollaboratorInput input____ =
    Encode.maybeObject
        [ ( "userId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.userId |> Just ), ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeRepositoryInvitationOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.RepositoryInvitationOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias RepositoryMigrationOrderRequiredFields =
    { field : Api.Enum.RepositoryMigrationOrderField.RepositoryMigrationOrderField
    , direction : Api.Enum.RepositoryMigrationOrderDirection.RepositoryMigrationOrderDirection
    }
...
encodeRepositoryMigrationOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.RepositoryMigrationOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.RepositoryMigrationOrderDirection.toString input____.direction |> Just ) ]
...
encodeRepositoryOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.RepositoryOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeRequestReviewsInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "userIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.userIds ), ( "teamIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.teamIds ), ( "union", Encode.bool |> Encode.optional input____.union ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias RequiredStatusCheckInputOptionalFields =
    { appId : OptionalArgument Api.ScalarCodecs.Id }
...
encodeRequiredStatusCheckInput input____ =
    Encode.maybeObject
        [ ( "context", Encode.string input____.context |> Just ), ( "appId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.appId ) ]
...
type alias RerequestCheckSuiteInputRequiredFields =
    { repositoryId : Api.ScalarCodecs.Id
    , checkSuiteId : Api.ScalarCodecs.Id
    }
...
encodeRerequestCheckSuiteInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "checkSuiteId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.checkSuiteId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeResolveReviewThreadInput input____ =
    Encode.maybeObject
        [ ( "threadId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.threadId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeSavedReplyOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SavedReplyOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeSecurityAdvisoryIdentifierFilter input____ =
    Encode.maybeObject
        [ ( "type", Encode.enum Api.Enum.SecurityAdvisoryIdentifierType.toString input____.type_ |> Just ), ( "value", Encode.string input____.value |> Just ) ]
...
encodeSecurityAdvisoryOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SecurityAdvisoryOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeSecurityVulnerabilityOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SecurityVulnerabilityOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias SetEnterpriseIdentityProviderInputRequiredFields =
    { enterpriseId : Api.ScalarCodecs.Id
    , ssoUrl : Api.ScalarCodecs.Uri
    , idpCertificate : String
    , signatureMethod : Api.Enum.SamlSignatureAlgorithm.SamlSignatureAlgorithm
    , digestMethod : Api.Enum.SamlDigestAlgorithm.SamlDigestAlgorithm
    }
...
encodeSetEnterpriseIdentityProviderInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "ssoUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) input____.ssoUrl |> Just ), ( "issuer", Encode.string |> Encode.optional input____.issuer ), ( "idpCertificate", Encode.string input____.idpCertificate |> Just ), ( "signatureMethod", Encode.enum Api.Enum.SamlSignatureAlgorithm.toString input____.signatureMethod |> Just ), ( "digestMethod", Encode.enum Api.Enum.SamlDigestAlgorithm.toString input____.digestMethod |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias SetOrganizationInteractionLimitInputRequiredFields =
    { organizationId : Api.ScalarCodecs.Id
    , limit : Api.Enum.RepositoryInteractionLimit.RepositoryInteractionLimit
    }


type alias SetOrganizationInteractionLimitInputOptionalFields =
    { expiry : OptionalArgument Api.Enum.RepositoryInteractionLimitExpiry.RepositoryInteractionLimitExpiry
    , clientMutationId : OptionalArgument String
    }
...
encodeSetOrganizationInteractionLimitInput input____ =
    Encode.maybeObject
        [ ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "limit", Encode.enum Api.Enum.RepositoryInteractionLimit.toString input____.limit |> Just ), ( "expiry", Encode.enum Api.Enum.RepositoryInteractionLimitExpiry.toString |> Encode.optional input____.expiry ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeSetRepositoryInteractionLimitInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "limit", Encode.enum Api.Enum.RepositoryInteractionLimit.toString input____.limit |> Just ), ( "expiry", Encode.enum Api.Enum.RepositoryInteractionLimitExpiry.toString |> Encode.optional input____.expiry ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeSetUserInteractionLimitInput input____ =
    Encode.maybeObject
        [ ( "userId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.userId |> Just ), ( "limit", Encode.enum Api.Enum.RepositoryInteractionLimit.toString input____.limit |> Just ), ( "expiry", Encode.enum Api.Enum.RepositoryInteractionLimitExpiry.toString |> Encode.optional input____.expiry ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias SponsorOrderRequiredFields =
    { field : Api.Enum.SponsorOrderField.SponsorOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeSponsorOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SponsorOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias SponsorableOrderRequiredFields =
    { field : Api.Enum.SponsorableOrderField.SponsorableOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeSponsorableOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SponsorableOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias SponsorsActivityOrderRequiredFields =
    { field : Api.Enum.SponsorsActivityOrderField.SponsorsActivityOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeSponsorsActivityOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SponsorsActivityOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeSponsorsTierOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SponsorsTierOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias SponsorshipNewsletterOrderRequiredFields =
    { field : Api.Enum.SponsorshipNewsletterOrderField.SponsorshipNewsletterOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeSponsorshipNewsletterOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SponsorshipNewsletterOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeSponsorshipOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.SponsorshipOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeStarOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.StarOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias StartRepositoryMigrationInputRequiredFields =
    { sourceId : Api.ScalarCodecs.Id
    , ownerId : Api.ScalarCodecs.Id
    , sourceRepositoryUrl : Api.ScalarCodecs.Uri
...
encodeStartRepositoryMigrationInput input____ =
    Encode.maybeObject
        [ ( "sourceId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.sourceId |> Just ), ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "sourceRepositoryUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) input____.sourceRepositoryUrl |> Just ), ( "repositoryName", Encode.string input____.repositoryName |> Just ), ( "continueOnError", Encode.bool |> Encode.optional input____.continueOnError ), ( "gitArchiveUrl", Encode.string |> Encode.optional input____.gitArchiveUrl ), ( "metadataArchiveUrl", Encode.string |> Encode.optional input____.metadataArchiveUrl ), ( "accessToken", Encode.string input____.accessToken |> Just ), ( "githubPat", Encode.string |> Encode.optional input____.githubPat ), ( "skipReleases", Encode.bool |> Encode.optional input____.skipReleases ), ( "targetRepoVisibility", Encode.string |> Encode.optional input____.targetRepoVisibility ), ( "lockSource", Encode.bool |> Encode.optional input____.lockSource ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeSubmitPullRequestReviewInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.pullRequestId ), ( "pullRequestReviewId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.pullRequestReviewId ), ( "event", Encode.enum Api.Enum.PullRequestReviewEvent.toString input____.event |> Just ), ( "body", Encode.string |> Encode.optional input____.body ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeTeamDiscussionCommentOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.TeamDiscussionCommentOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeTeamDiscussionOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.TeamDiscussionOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeTeamMemberOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.TeamMemberOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeTeamOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.TeamOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeTeamRepositoryOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.TeamRepositoryOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
encodeTransferIssueInput input____ =
    Encode.maybeObject
        [ ( "issueId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.issueId |> Just ), ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "createLabelsIfMissing", Encode.bool |> Encode.optional input____.createLabelsIfMissing ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUnlockLockableInput input____ =
    Encode.maybeObject
        [ ( "lockableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.lockableId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUnmarkIssueAsDuplicateInput input____ =
    Encode.maybeObject
        [ ( "duplicateId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.duplicateId |> Just ), ( "canonicalId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.canonicalId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateCheckRunInputRequiredFields =
    { repositoryId : Api.ScalarCodecs.Id
    , checkRunId : Api.ScalarCodecs.Id
    }
...
encodeUpdateCheckRunInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "checkRunId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.checkRunId |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "detailsUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) |> Encode.optional input____.detailsUrl ), ( "externalId", Encode.string |> Encode.optional input____.externalId ), ( "status", Encode.enum Api.Enum.RequestableCheckStatusState.toString |> Encode.optional input____.status ), ( "startedAt", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.startedAt ), ( "conclusion", Encode.enum Api.Enum.CheckConclusionState.toString |> Encode.optional input____.conclusion ), ( "completedAt", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.completedAt ), ( "output", encodeCheckRunOutput |> Encode.optional input____.output ), ( "actions", (encodeCheckRunAction |> Encode.list) |> Encode.optional input____.actions ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateCheckSuitePreferencesInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "autoTriggerPreferences", (encodeCheckSuiteAutoTriggerPreference |> Encode.list) input____.autoTriggerPreferences |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateDiscussionCommentInput input____ =
    Encode.maybeObject
        [ ( "commentId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.commentId |> Just ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateDiscussionInput input____ =
    Encode.maybeObject
        [ ( "discussionId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.discussionId |> Just ), ( "title", Encode.string |> Encode.optional input____.title ), ( "body", Encode.string |> Encode.optional input____.body ), ( "categoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.categoryId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateEnterpriseAdministratorRoleInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "login", Encode.string input____.login |> Just ), ( "role", Encode.enum Api.Enum.EnterpriseAdministratorRole.toString input____.role |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateEnterpriseAllowPrivateRepositoryForkingSettingInputOptionalFields =
    { policyValue : OptionalArgument Api.Enum.EnterpriseAllowPrivateRepositoryForkingPolicyValue.EnterpriseAllowPrivateRepositoryForkingPolicyValue
    , clientMutationId : OptionalArgument String
    }
...
encodeUpdateEnterpriseAllowPrivateRepositoryForkingSettingInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.Enum.EnterpriseEnabledDisabledSettingValue.toString input____.settingValue |> Just ), ( "policyValue", Encode.enum Api.Enum.EnterpriseAllowPrivateRepositoryForkingPolicyValue.toString |> Encode.optional input____.policyValue ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateEnterpriseDefaultRepositoryPermissionSettingInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.Enum.EnterpriseDefaultRepositoryPermissionSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateEnterpriseMembersCanChangeRepositoryVisibilitySettingInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.Enum.EnterpriseEnabledDisabledSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateEnterpriseMembersCanMakePurchasesSettingInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.Enum.EnterpriseMembersCanMakePurchasesSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateEnterpriseOwnerOrganizationRoleInputRequiredFields =
    { enterpriseId : Api.ScalarCodecs.Id
    , organizationId : Api.ScalarCodecs.Id
    , organizationRole : Api.Enum.RoleInOrganization.RoleInOrganization
    }
...
encodeUpdateEnterpriseOwnerOrganizationRoleInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "organizationRole", Encode.enum Api.Enum.RoleInOrganization.toString input____.organizationRole |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateEnterpriseProfileInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "websiteUrl", Encode.string |> Encode.optional input____.websiteUrl ), ( "location", Encode.string |> Encode.optional input____.location ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateEnterpriseTwoFactorAuthenticationRequiredSettingInput input____ =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.Enum.EnterpriseEnabledSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateEnvironmentInputRequiredFields =
    { environmentId : Api.ScalarCodecs.Id }


type alias UpdateEnvironmentInputOptionalFields =
    { waitTimer : OptionalArgument Int
    , reviewers : OptionalArgument (List Api.ScalarCodecs.Id)
    , clientMutationId : OptionalArgument String
    }
...
encodeUpdateEnvironmentInput input____ =
    Encode.maybeObject
        [ ( "environmentId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.environmentId |> Just ), ( "waitTimer", Encode.int |> Encode.optional input____.waitTimer ), ( "reviewers", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.reviewers ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateIpAllowListEnabledSettingInputRequiredFields =
    { ownerId : Api.ScalarCodecs.Id
    , settingValue : Api.Enum.IpAllowListEnabledSettingValue.IpAllowListEnabledSettingValue
    }
...
encodeUpdateIpAllowListEnabledSettingInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "settingValue", Encode.enum Api.Enum.IpAllowListEnabledSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateIpAllowListEntryInput input____ =
    Encode.maybeObject
        [ ( "ipAllowListEntryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ipAllowListEntryId |> Just ), ( "allowListValue", Encode.string input____.allowListValue |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "isActive", Encode.bool input____.isActive |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateIpAllowListForInstalledAppsEnabledSettingInputRequiredFields =
    { ownerId : Api.ScalarCodecs.Id
    , settingValue : Api.Enum.IpAllowListForInstalledAppsEnabledSettingValue.IpAllowListForInstalledAppsEnabledSettingValue
    }
...
encodeUpdateIpAllowListForInstalledAppsEnabledSettingInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "settingValue", Encode.enum Api.Enum.IpAllowListForInstalledAppsEnabledSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateIssueCommentInput input____ =
    Encode.maybeObject
        [ ( "id", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.id |> Just ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateIssueInput input____ =
    Encode.maybeObject
        [ ( "id", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.id |> Just ), ( "title", Encode.string |> Encode.optional input____.title ), ( "body", Encode.string |> Encode.optional input____.body ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.assigneeIds ), ( "milestoneId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.milestoneId ), ( "labelIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.labelIds ), ( "state", Encode.enum Api.Enum.IssueState.toString |> Encode.optional input____.state ), ( "projectIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.projectIds ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateNotificationRestrictionSettingInputRequiredFields =
    { ownerId : Api.ScalarCodecs.Id
    , settingValue : Api.Enum.NotificationRestrictionSettingValue.NotificationRestrictionSettingValue
    }
...
encodeUpdateNotificationRestrictionSettingInput input____ =
    Encode.maybeObject
        [ ( "ownerId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.ownerId |> Just ), ( "settingValue", Encode.enum Api.Enum.NotificationRestrictionSettingValue.toString input____.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateOrganizationAllowPrivateRepositoryForkingSettingInput input____ =
    Encode.maybeObject
        [ ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "forkingEnabled", Encode.bool input____.forkingEnabled |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateOrganizationWebCommitSignoffSettingInput input____ =
    Encode.maybeObject
        [ ( "organizationId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.organizationId |> Just ), ( "webCommitSignoffRequired", Encode.bool input____.webCommitSignoffRequired |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateProjectCardInput input____ =
    Encode.maybeObject
        [ ( "projectCardId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectCardId |> Just ), ( "isArchived", Encode.bool |> Encode.optional input____.isArchived ), ( "note", Encode.string |> Encode.optional input____.note ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateProjectColumnInput input____ =
    Encode.maybeObject
        [ ( "projectColumnId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectColumnId |> Just ), ( "name", Encode.string input____.name |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateProjectDraftIssueInputRequiredFields =
    { draftIssueId : Api.ScalarCodecs.Id }
...
encodeUpdateProjectDraftIssueInput input____ =
    Encode.maybeObject
        [ ( "draftIssueId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.draftIssueId |> Just ), ( "title", Encode.string |> Encode.optional input____.title ), ( "body", Encode.string |> Encode.optional input____.body ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.assigneeIds ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateProjectInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "body", Encode.string |> Encode.optional input____.body ), ( "state", Encode.enum Api.Enum.ProjectState.toString |> Encode.optional input____.state ), ( "public", Encode.bool |> Encode.optional input____.public ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateProjectNextItemFieldInputOptionalFields =
    { projectId : OptionalArgument Api.ScalarCodecs.Id
    , itemId : OptionalArgument Api.ScalarCodecs.Id
    , fieldId : OptionalArgument Api.ScalarCodecs.Id
...
encodeUpdateProjectNextItemFieldInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.projectId ), ( "itemId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.itemId ), ( "fieldId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.fieldId ), ( "value", Encode.string |> Encode.optional input____.value ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateProjectV2ItemFieldValueInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "itemId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.itemId |> Just ), ( "fieldId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.fieldId |> Just ), ( "value", encodeProjectV2FieldValue input____.value |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateProjectV2ItemPositionInputOptionalFields =
    { afterId : OptionalArgument Api.ScalarCodecs.Id
    , clientMutationId : OptionalArgument String
    }
...
encodeUpdateProjectV2ItemPositionInput input____ =
    Encode.maybeObject
        [ ( "projectId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.projectId |> Just ), ( "itemId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.itemId |> Just ), ( "afterId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.afterId ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdatePullRequestBranchInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "expectedHeadOid", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input____.expectedHeadOid ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdatePullRequestInput input____ =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestId |> Just ), ( "baseRefName", Encode.string |> Encode.optional input____.baseRefName ), ( "title", Encode.string |> Encode.optional input____.title ), ( "body", Encode.string |> Encode.optional input____.body ), ( "state", Encode.enum Api.Enum.PullRequestUpdateState.toString |> Encode.optional input____.state ), ( "maintainerCanModify", Encode.bool |> Encode.optional input____.maintainerCanModify ), ( "assigneeIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.assigneeIds ), ( "milestoneId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.milestoneId ), ( "labelIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.labelIds ), ( "projectIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.projectIds ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdatePullRequestReviewCommentInput input____ =
    Encode.maybeObject
        [ ( "pullRequestReviewCommentId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestReviewCommentId |> Just ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdatePullRequestReviewInput input____ =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.pullRequestReviewId |> Just ), ( "body", Encode.string input____.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateRefInput input____ =
    Encode.maybeObject
        [ ( "refId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.refId |> Just ), ( "oid", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecGitObjectID) input____.oid |> Just ), ( "force", Encode.bool |> Encode.optional input____.force ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateRepositoryInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "template", Encode.bool |> Encode.optional input____.template ), ( "homepageUrl", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) |> Encode.optional input____.homepageUrl ), ( "hasWikiEnabled", Encode.bool |> Encode.optional input____.hasWikiEnabled ), ( "hasIssuesEnabled", Encode.bool |> Encode.optional input____.hasIssuesEnabled ), ( "hasProjectsEnabled", Encode.bool |> Encode.optional input____.hasProjectsEnabled ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateRepositoryWebCommitSignoffSettingInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "webCommitSignoffRequired", Encode.bool input____.webCommitSignoffRequired |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateSponsorshipPreferencesInput input____ =
    Encode.maybeObject
        [ ( "sponsorId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorId ), ( "sponsorLogin", Encode.string |> Encode.optional input____.sponsorLogin ), ( "sponsorableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.sponsorableId ), ( "sponsorableLogin", Encode.string |> Encode.optional input____.sponsorableLogin ), ( "receiveEmails", Encode.bool |> Encode.optional input____.receiveEmails ), ( "privacyLevel", Encode.enum Api.Enum.SponsorshipPrivacy.toString |> Encode.optional input____.privacyLevel ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateSubscriptionInput input____ =
    Encode.maybeObject
        [ ( "subscribableId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.subscribableId |> Just ), ( "state", Encode.enum Api.Enum.SubscriptionState.toString input____.state |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateTeamDiscussionCommentInput input____ =
    Encode.maybeObject
        [ ( "id", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.id |> Just ), ( "body", Encode.string input____.body |> Just ), ( "bodyVersion", Encode.string |> Encode.optional input____.bodyVersion ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
type alias UpdateTeamsRepositoryInputRequiredFields =
    { repositoryId : Api.ScalarCodecs.Id
    , teamIds : List Api.ScalarCodecs.Id
    , permission : Api.Enum.RepositoryPermission.RepositoryPermission
    }
...
encodeUpdateTeamsRepositoryInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "teamIds", ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) input____.teamIds |> Just ), ( "permission", Encode.enum Api.Enum.RepositoryPermission.toString input____.permission |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUpdateTopicsInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "topicNames", (Encode.string |> Encode.list) input____.topicNames |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
encodeUserStatusOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.UserStatusOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias VerifiableDomainOrderRequiredFields =
    { field : Api.Enum.VerifiableDomainOrderField.VerifiableDomainOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeVerifiableDomainOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.VerifiableDomainOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
...
type alias WorkflowRunOrderRequiredFields =
    { field : Api.Enum.WorkflowRunOrderField.WorkflowRunOrderField
    , direction : Api.Enum.OrderDirection.OrderDirection
    }
...
encodeWorkflowRunOrder input____ =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.Enum.WorkflowRunOrderField.toString input____.field |> Just ), ( "direction", Encode.enum Api.Enum.OrderDirection.toString input____.direction |> Just ) ]
