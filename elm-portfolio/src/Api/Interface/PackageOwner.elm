...
module Api.Interface.PackageOwner exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Interface.PackageOwner
...
id : SelectionSet Api.ScalarCodecs.Id Api.Interface.PackageOwner
id =
