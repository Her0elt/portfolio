...
module Api.Interface.RequirableByPullRequest exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Interface.RequirableByPullRequest
...
isRequired :
    ...
    -> SelectionSet Bool Api.Interface.RequirableByPullRequest
