...
module Api.Interface.ProjectV2Owner exposing (..)
...
id : SelectionSet Api.ScalarCodecs.Id Api.Interface.ProjectV2Owner
id =
...
projectV2 :
    ...
    -> SelectionSet (Maybe decodesTo) Api.Interface.ProjectV2Owner
