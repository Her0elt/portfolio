...
import Api.Enum.DependencyGraphEcosystem
...
marketplaceCategories :
    ...
    -> SelectionSet decodesTo Api.Object.MarketplaceCategory
...
marketplaceListing :
    ...
    -> SelectionSet decodesTo Api.Object.MarketplaceListing
    -> SelectionSet (Maybe decodesTo) RootQuery
...
marketplaceListings :
    ...
    -> SelectionSet decodesTo Api.Object.MarketplaceListingConnection
...
-}
meta :
    SelectionSet decodesTo Api.Object.GitHubMetadata
    -> SelectionSet decodesTo RootQuery
meta object____ =
...
nodes requiredArgs____ object____ =
    Object.selectionForCompositeField "nodes" [ Argument.required "ids" requiredArgs____.ids ((Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecId) |> Encode.list) ] object____ (Basics.identity >> Decode.nullable >> Decode.list)
...
rateLimit :
    ...
    -> SelectionSet decodesTo Api.Object.RateLimit
    -> SelectionSet (Maybe decodesTo) RootQuery
...
resource requiredArgs____ object____ =
    Object.selectionForCompositeField "resource" [ Argument.required "url" requiredArgs____.url (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUri) ] object____ (Basics.identity >> Decode.nullable)
    ...
    let
        ...
        optionalArgs____ =
            [ Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int ]
                |> List.filterMap Basics.identity
    in
    Object.selectionForCompositeField "search" (optionalArgs____ ++ [ Argument.required "query" requiredArgs____.query Encode.string, Argument.required "type" requiredArgs____.type_ (Encode.enum Api.Enum.SearchType.toString) ]) object____ Basics.identity
...
securityAdvisories :
    ...
    -> SelectionSet decodesTo Api.Object.SecurityAdvisoryConnection
    -> SelectionSet decodesTo RootQuery
securityAdvisories fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "orderBy" filledInOptionals____.orderBy Api.InputObject.encodeSecurityAdvisoryOrder, Argument.optional "identifier" filledInOptionals____.identifier Api.InputObject.encodeSecurityAdvisoryIdentifierFilter, Argument.optional "publishedSince" filledInOptionals____.publishedSince (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime), Argument.optional "updatedSince" filledInOptionals____.updatedSince (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecDateTime), Argument.optional "classifications" filledInOptionals____.classifications (Encode.enum Api.Enum.SecurityAdvisoryClassification.toString |> Encode.list), Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int ]
                |> List.filterMap Basics.identity
    in
...
type alias SponsorablesOptionalArguments =
    ...
    , first : OptionalArgument Int
    , last : OptionalArgument Int
    , orderBy : OptionalArgument Api.InputObject.SponsorableOrder
    , onlyDependencies : OptionalArgument Bool
    , orgLoginForDependencies : OptionalArgument String
    , dependencyEcosystem : OptionalArgument Api.Enum.SecurityAdvisoryEcosystem.SecurityAdvisoryEcosystem
    , ecosystem : OptionalArgument Api.Enum.DependencyGraphEcosystem.DependencyGraphEcosystem
    }
...
sponsorables :
    ...
    -> SelectionSet decodesTo Api.Object.SponsorableItemConnection
    -> SelectionSet decodesTo RootQuery
